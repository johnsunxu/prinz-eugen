...
class shipGearFinder(commands.Cog):
    ...
    #        closeButton.click()
        ...
        #    driver.quit()
            ...
            thumbnailImage = Image.open(image_bytes).resize((85,85)).convert("RGB")



            #put thumbnail on image
            img.paste(thumbnailImage,(10,10))
            draw = ImageDraw.Draw(img);

            #draw name
            draw.text((105,10),shipData['names']['en'],fill='white',font=fontName)
